                ...
                public void onClick(View v) {
                    ...
                    for (WordBuilder builder :list) {
                        ...
                        if(list1.contains(wrongword)){
                            Toast.makeText(NetWordActivity.this,"该单词已在生词本中，请勿重复添加",Toast.LENGTH_SHORT).show();
            ...
            wordBuilder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for (WordBuilder builder :list) {
                        ...
                        if(list1.contains(renglish)){
                            Toast.makeText(NetWordActivity.this,"该单词已在生词本中，请勿重复添加",Toast.LENGTH_SHORT).show();

                        }else{
                            WordBuilder wordBuilder1 = new WordBuilder();
                            wordBuilder1.setWbenglish(renglish);
                            wordBuilder1.setWbchinese(rchinese);
                            wordBuilder1.save();
